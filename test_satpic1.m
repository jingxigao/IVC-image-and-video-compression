...
FILTERED_image_R=prefilterlowpass2d(ORIGINAL_image(:,:,1));
FILTERED_image_G=prefilterlowpass2d(ORIGINAL_image(:,:,2));
FILTERED_image_B=prefilterlowpass2d(ORIGINAL_image(:,:,3));
%Step 2
...
FILTERED_image_subsampled_cols_rows=downsample(FILTERED_image_subsampled_cols,2);
FILTERED_image_subsampled = permute(FILTERED_image_subsampled_cols_rows, [2 1 3]);
%Step 2 up
...
%(e) Post-filter
%Step 1
FILTERED_image_RR = prefilterlowpass2d( FILTERED_image_2(:,:,1) );
FILTERED_image_GG = prefilterlowpass2d( FILTERED_image_2(:,:,2) );
FILTERED_image_BB = prefilterlowpass2d( FILTERED_image_2(:,:,3) );
%Step 2
FILTERED_image_3(:,:,1) = 4*FILTERED_image_RR;
FILTERED_image_3(:,:,2) = 4*FILTERED_image_GG;
FILTERED_image_3(:,:,3) = 4*FILTERED_image_BB;
% FILTERED_image_3(:,:,1) = FILTERED_image_RR;
% FILTERED_image_3(:,:,2) = FILTERED_image_GG;
% FILTERED_image_3(:,:,3) = FILTERED_image_BB;
%Step 3: Plot
% figure(3)
...
%Step 2 Post-filter
%
FILTERED_image_RRR = prefilterlowpass2d( FILTERED_image_22(:,:,1) );
FILTERED_image_GGG = prefilterlowpass2d( FILTERED_image_22(:,:,2) );
FILTERED_image_BBB = prefilterlowpass2d( FILTERED_image_22(:,:,3) );
%
