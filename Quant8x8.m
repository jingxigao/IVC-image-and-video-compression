function [ block_out_Y, block_out_Cb, block_out_Cr ] = Quant8x8( block_in_Y, block_in_Cb, block_in_Cr,factor)
%quantize the transform coefficients of 8x8 block given lookup tables
