...
%         b_rate((g-1)*7+2)= bit_rate_temp2;   
   ...
   %% -------------use 2nd or 4th frame to predict 3rd frame------
        ...
        [ mv, error_Y,error_Cb,error_Cr, pred_Y1,pred_Cb1,pred_Cr1 ] = blockmatch( Y_recon_sub2,Cb_recon_sub2,Cr_recon_sub2,Y_curr_sub,Cb_curr_sub,Cr_curr_sub);
        [ bit_rate_temp1, Y_recon1, Cb_recon1, Cr_recon1] =InterMode( mv, error_Y,error_Cb,error_Cr,  pred_Y1,pred_Cb1,pred_Cr1, a,size(Y_curr_sub));
        [Cb_up1,Cr_up1] = chroma_upsample(Cb_recon1,Cr_recon1);  
...
%           imshow(ORIGINAL_image(:,:,:,(g-1)*7+7)/255) 
  ...
  %    
        ...
        %% use 5th or 7th frame to predict 6th frame
        ...
        [ mv, error_Y,error_Cb,error_Cr, pred_Y1,pred_Cb1,pred_Cr1 ] = blockmatch( Y_recon_sub5,Cb_recon_sub5,Cr_recon_sub5,Y_curr_sub,Cb_curr_sub,Cr_curr_sub);
        [ bit_rate_temp1, Y_recon1, Cb_recon1, Cr_recon1] =InterMode( mv, error_Y,error_Cb,error_Cr,  pred_Y1,pred_Cb1,pred_Cr1, a,size(Y_curr_sub));
        [Cb_up1,Cr_up1] = chroma_upsample(Cb_recon1,Cr_recon1);  
